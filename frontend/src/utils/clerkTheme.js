...
export const clerkLightTheme = {
  ...
  elements: {
    ...
    socialButtons: 'flex flex-col gap-2 w-full mb-3',
    socialButtonsBlockButton: 'border border-slate-200 hover:border-slate-300 bg-white hover:bg-slate-50 text-slate-700 text-xs font-semibold py-2.5 px-4 shadow-xs hover:shadow-sm transition-all rounded-xl flex items-center justify-center gap-2 cursor-pointer w-full',
    ...
    dividerRow: 'my-3 flex items-center justify-between w-full',
    dividerLine: 'bg-slate-200 flex-1 h-[1px]',
    dividerText: 'text-slate-400 text-[11px] font-mono uppercase tracking-wider px-2.5',
