              ...
              <div className="relative z-10">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4">
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-2xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold flex items-center gap-2 transition-all shadow-lg shadow-emerald-500/20 cursor-pointer"
                  >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
              ...
              <div className="lg:col-span-3">
                ...
                <IOSGlassCard interactive={false} className="rounded-2xl overflow-hidden p-0">
                  ...
                  <div className="p-3 border-t border-slate-100 dark:border-slate-700 flex items-center gap-4 text-[10px] flex-wrap">
              ...
              <div className="lg:col-span-2">
                ...
                <IOSGlassCard className="p-4 rounded-2xl h-80 sm:h-96 flex flex-col">
                  ...
                  <div className="flex-1 rounded-2xl overflow-hidden relative bg-slate-800 dark:bg-black flex items-center justify-center">
                  ...
                  <div className="mt-3 space-y-2">
                    <div className="p-2.5 rounded-2xl bg-emerald-500/10 border border-emerald-300/40 dark:border-emerald-700/40">
                  ...
                  {AI_PREDICTIONS.map((p, i) => (
                    <IOSGlassCard key={i} className="p-4 rounded-2xl">
                      <div className="flex items-start justify-between gap-2 mb-1.5">
                        ...
                        <span className="text-[10px] font-bold text-emerald-600 dark:text-emerald-400 bg-emerald-500/10 px-2 py-0.5 rounded-full shrink-0">{p.conf}% conf.</span>
                      </div>
                ...
                <div>
                  ...
                  <div className="space-y-2.5">
                    {ACTIVE_WARNINGS.map((w, i) => {
                      ...
                      return (
                        <div key={i} className={`rounded-2xl border ${cfg.border} ${cfg.bg} p-3`}>
                          <div className="flex items-start justify-between gap-2 mb-1.5">
                    ...
                    <thead>
                      <tr className="bg-emerald-500/10 dark:bg-emerald-950/30 border-b border-emerald-200 dark:border-emerald-900/60">
                        {['District / State', 'Risk Level', 'Storm Surge', 'Winds', 'Expected Rainfall', 'Evacuation Status'].map(h => (
                          <th key={h} className="px-4 py-2.5 text-left text-[10px] font-bold uppercase tracking-wider text-emerald-700 dark:text-emerald-400 whitespace-nowrap">{h}</th>
                        ))}
                      </tr>
                    </thead>
                    <tbody>
